...
@section('title') ผู้ที่รับอีเมล @endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">เพิ่ม / แก้ไข ผู้ที่รับอีเมล</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">                       
                        <li class="breadcrumb-item"><a href="javascript: void(0);">ข้อมูลหลัก</a></li>
                        <li class="breadcrumb-item">ผู้ที่รับอีเมล</li>
                        <li class="breadcrumb-item active">เพิ่ม / แก้ไข ผู้ที่รับอีเมล</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                @if (empty($sRow))
                    <form action="{{ route('backend.masters.receive-email.store') }}" method="POST" autocomplete="off">
                @else
                    <form action="{{ route('backend.masters.receive-email.update', $sRow->id) }}" method="POST" autocomplete="off">
                ...
                @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="email" value="{{ $sRow->email??'' }}" name="email">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group mb-0 row">
                        <div class="col-md-6">
                            <a class="btn btn-secondary btn-sm waves-effect"
                                href="{{ route('backend.masters.receive-email.index') }}">
