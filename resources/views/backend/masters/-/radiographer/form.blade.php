...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Add / Edit Radiographer</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
				@if( empty($sRow) )
				<form action="{{ route('backend.masters.radiographer.store') }}" method="POST" autocomplete="off">
					@else
					<form action="{{ route('backend.masters.radiographer.update', $sRow->id ) }}" method="POST" autocomplete="off">
						...
						<div class="form-group row">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" value="{{ $sRow->codes??'' }}" name="codes" placeholder="Code">
							</div>
						</div>						
						<div class="form-group row">
						...
						<div class="form-group mb-0 row">
							<div class="col-md-6">
								<a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.masters.radiographer.index') }}">
