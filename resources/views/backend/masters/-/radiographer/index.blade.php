...
@section('title') Radiographer  @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Radiographer</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Backend</a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Masters</a></li>
                    <li class="breadcrumb-item active">Radiographer </li>
                </ol>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-12 text-right">
                    <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.masters.radiographer.create') }}">
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.masters.radiographer.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        columns: [
            ...
            {data: 'codes', 				title :'<center>Code</center>', 	className: 'text-center'},
        ...
        rowCallback: function(nRow, aData, dataIndex){
			...
			$('td:eq(0)', nRow).html(''	
				+ '<a href="{{ route('backend.masters.radiographer.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
				+ '<a href="javascript: void(0);" data-url="{{ route('backend.masters.radiographer.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"><i class="bx bx-trash font-size-16 align-middle"></i></a>'
			).addClass('input');			
			$('td:eq(2)', nRow).html(''					
