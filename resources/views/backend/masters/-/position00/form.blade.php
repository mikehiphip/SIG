            ...
            <div class="card">
                ...
                @endif
                            ...
                            <select class="form-control" name="types">
                                ...
                                @if ($sHtypes)
                                    @foreach ($sHtypes as $v)
                                        <option value="{{ $v }}" {{ isset($sRow) && $sRow->types == $v ? 'selected' : '' }}>
                                            {{ $v }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $sRow->name_open_invoice ?? '' }}"
                                name="name_open_invoice" placeholder="Name Open Invoice" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-md-2 col-form-label">Tax Id</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $sRow->tax_id ?? '' }}" name="tax_id"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $sRow->address ?? '' }}" name="address"
                                    ...
                                    <div data-repeater-item class="outer">
                                        ...
                                        <div class="inner-repeater">
                                                ...
                                                @if ($sPhysicianId)
                                                    @foreach ($sPhysicianId as $rs)
                                                        <div data-repeater-item class="inner row">
                                                            <div class="col-md-10">
                                                                <select class="form-control c_add_select2" name="id_physician">
                                                                    <option value="">Select</option>
                                                                    @if ($sPhysician)
                                            ...
                                            <input data-repeater-create type="button"
                                                class="btn btn-success inner btn_run_select2"
                                                value="Add Price" />
                                        </div>
                    ...
                    <div class="form-group mb-0 row">
                        <div class="col-md-6">
                            <a class="btn btn-secondary btn-sm waves-effect"
                                href="{{ route('backend.masters.hospital.index') }}">
