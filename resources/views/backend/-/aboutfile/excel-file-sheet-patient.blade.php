...
@section('title') Excel Import File Sheet Patient @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Excel Import File Sheet Patient</h4>
			
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Backend</a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">File</a></li>
                    <li class="breadcrumb-item active">Excel Import File Sheet Patient</li>
				</ol>
			</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">               
				<form action="{{ url('backend/aboutfile/excel-file-sheet-patient-upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="upload">Import File Input Patient</label>
