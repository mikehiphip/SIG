...
@section('title') Endourologic @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Endourologic</h4>
            ...
            <div class="card-body">
                <div class="row">
					...
					<div class="col-12 text-right">
						<a class="btn btn-info btn-sm mt-1" href="{{ route('backend.sheet.endourologic-patient.create') }}">
...
<script>
	...
	$(function() {
		oTable = $('#data-table').DataTable({
			...
			iDisplayLength: 25,
			ajax: {
				url: '{{ route('backend.sheet.endourologic-patient.datatable') }}',
				data: function ( d ) {
					d.Where={};
			...
			rowCallback: function(nRow, aData, dataIndex){	
				...
				$('td:eq(0)', nRow).html(''
					+ '<a href="{{ route('backend.sheet.endourologic-patient.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
					+ '<a href="javascript: void(0);" data-url="{{ route('backend.sheet.endourologic-patient.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"><i class="bx bx-trash font-size-16 align-middle"></i></a>'
				).addClass('input');
				...
				$('td:eq(6)', nRow).html(''					
					+ ((aData['conclusion_equipment_charge']) ? aData['conclusion_equipment_charge'] : '<center>-</center>') 
					+ ''
				).addClass('input');
			}
		});
