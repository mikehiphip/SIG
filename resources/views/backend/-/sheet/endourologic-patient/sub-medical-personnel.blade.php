			...
			<div data-repeater-list="outer-group2" class="outer">
				<div data-repeater-item class="outer">								
					...
					<div class="inner-repeater">
						...
						<input data-repeater-create type="button" class="btn btn-success inner btn_run_select2_group2" onclick="f_run_select2()" value="Add"/>
					</div>								
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<textarea class="form-control" id="detail_anesthesia_other" name="detail_anesthesia_other" rows="4" cols="50"></textarea>
	</div>
</div>
<div class="form-group row">
