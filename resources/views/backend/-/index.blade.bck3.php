...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="data-table-eswl" class="table table-bordered" style="width: 100%; min-width:100%;"></table>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="data-table-endo" class="table table-bordered" style="width: 100%; min-width:100%;"></table>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="data-table-surg" class="table table-bordered" style="width: 100%; min-width:100%;"></table>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('backend.inc_eswl')
    @include('backend.inc_endo')
    @include('backend.inc_surg')
@endsection
...
@section('script') 
    ...
    @yield('script-inc-eswl')
    @yield('script-inc-endo')
    @yield('script-inc-surg')
@endsection