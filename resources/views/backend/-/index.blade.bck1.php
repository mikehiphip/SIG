                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <center><div id="chart_div" style="width: 590px; height: 300px;"></div> </center>                        
                        </div>                        
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mt-12">
                                <center>
                                <a href="" style="width:80px" class="btn btn-primary waves-effect waves-light btn-sm">Day </i></a>
                                <a href="" style="width:80px" class="btn btn-primary waves-effect waves-light btn-sm">Week </a>
                                <a href="" style="width:80px" class="btn btn-primary waves-effect waves-light btn-sm">Month </a>
                                <a href="" style="width:80px" class="btn btn-primary waves-effect waves-light btn-sm">Year </a>
                                </center>
                            </div>
                        </div>                        
                    </div>
